...
document.getElementById("facebook").onclick = function() {
  location.href = "https://www.facebook.com/profile.php?id=100086095306186";
}
  document.getElementById("instagram").onclick = function() {
    location.href = "https://www.instagram.com/haider_66789/?hl=en"; 
};

document.getElementById("twitter").onclick = function() {
  location.href = "https://twitter.com/Muhamma11862836"; 
};

document.getElementById("linkedin").onclick = function() {
  location.href = "https://www.linkedin.com/in/muhammad-haider-2bbb1824a/"; 
};